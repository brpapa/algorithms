...
<p align="center">
<a href="https: //uhunt.onlinejudge.org/id/1094350"><img src="https://img.shields.io/static/v1?label=uva&message=98&color=green&style=flat-square"></a>
<a href="https: //codeforces.com/profile/brnpapa"><img src="https://img.shields.io/static/v1?label=codeforces&message=74&color=green&style=flat-square"></a>
...
· [#divide-&-conquer](#divide-&-conquer) · [#searching](#searching) · [#math](#math) · [#dynamic-programming](#dynamic-programming) · [#miscellaneous](#miscellaneous) · [#ad-hoc](#ad-hoc) · [#graphs](#graphs) · [#geometry](#geometry) · [#brute-force](#brute-force) · [#greedy](#greedy) ·
...
- **maximum flow**
	- 🙂 [uva/820](https://github.com/brnpapa/competitive-programming/blob/master/solutions/uva/820.cpp) 
	- **minimum cost**
		- 🙂 [uva/10594](https://github.com/brnpapa/competitive-programming/blob/master/solutions/uva/10594.cpp) 
- **specials**
