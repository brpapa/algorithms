...
· [#brute-force](#brute-force) · [#searching](#searching) · [#dynamic-programming](#dynamic-programming) · [#graphs](#graphs) · [#miscellaneous](#miscellaneous) · [#greedy](#greedy) · [#math](#math) · [#geometry](#geometry) · [#divide-&-conquer](#divide-&-conquer) · [#ad-hoc](#ad-hoc) ·
