...
<p align="center">
<a href="https://uhunt.onlinejudge.org/id/1094350"><img src="https://img.shields.io/static/v1?label=uva&message=90&color=green&style=flat-square"></a>
<a href="https://codeforces.com/profile/brnpapa"><img src="https://img.shields.io/static/v1?label=codeforces&message=66&color=green&style=flat-square"></a>
...
· [#ad-hoc](#ad-hoc) · [#searching](#searching) · [#dynamic-programming](#dynamic-programming) · [#graphs](#graphs) · [#math](#math) · [#brute-force](#brute-force) · [#miscellaneous](#miscellaneous) · [#computational-geometry](#computational-geometry) · [#divide-&-conquer](#divide-&-conquer) · [#greedy](#greedy) ·
...
- **ad-hoc**
	...
	- 🟢 [uva/10110](https://github.com/brnpapa/competitive-programming/blob/master/uva/10110.cpp): `check if the number of divisors of n is odd`  → check if n is a perfect square
	...
	- 🟡 [codeforces/573-A](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/573-A.cpp) 
	- 🟢 [spoj/BISHOPS](https://github.com/brnpapa/competitive-programming/blob/master/spoj/BISHOPS.py): `how many bishops can be placed on a n x n chessboard without threatening each other?` 
	- 🟢 [uva/10812](https://github.com/brnpapa/competitive-programming/blob/master/uva/10812.cpp) 
	- 🟢 [codeforces/16-C](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/16-C.cpp) 
...
- **number theory**
	...
	- **greatest common divisor (GCD)**
		- 🟡 [codeforces/75-C](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/75-C.cpp): `find the gcd(a, b) that is in a query range [lo .. hi]`  → note that all divisors of gcd(a, b) are also divisors of a and b
	...
	- **prime numbers**
		...
		- **sieve of eratosthenes**
			- 🟢 [codeforces/230-B](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/230-B.cpp): `check if a large n has exactily three distinct positive divisors`  → check if sqrt(n) is prime
...
- **minimum spanning tree (MST)**
	...
	- **minimum spanning subgraph**
		- 🟡 [uva/10397](https://github.com/brnpapa/competitive-programming/blob/master/uva/10397.cpp): `given an implicit complete graph and some edges, compute the cost of the minimum spanning subgraph` 
- **traversal**
