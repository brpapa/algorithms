The folder `notebook` contains general-purpose algorithms, and the folder `solutions` contains the solved problems. Feel free to follow my progress on my main online judge profiles:
...
· [#dynamic-programming](#dynamic-programming) · [#miscellaneous](#miscellaneous) · [#greedy](#greedy) · [#graphs](#graphs) · [#math](#math) · [#ad-hoc](#ad-hoc) · [#geometry](#geometry) · [#brute-force](#brute-force) · [#searching](#searching) · [#divide-&-conquer](#divide-&-conquer) ·
