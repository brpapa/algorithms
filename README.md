...
<a href="https://codeforces.com/profile/brnpapa"><img src="https://img.shields.io/static/v1?label=codeforces&message=56&color=red&style=flat-square"></a>
...
<a href="https://www.spoj.com/users/brnpapa"><img src="https://img.shields.io/static/v1?label=spoj&message=27&color=red&style=flat-square"></a>
</p>
<br/>
...
- **traversal**
	...
	- **depth-first search (DFS)**
		...
		- 📗 [spoj/MKJUMPS](https://github.com/brnpapa/competitive-programming/blob/master/spoj/MKJUMPS.cpp): `given an unweighted implicit graph, count the longest path` 
