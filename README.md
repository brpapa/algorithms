...
· [#graphs](#graphs) · [#brute-force](#brute-force) · [#miscellaneous](#miscellaneous) · [#divide-&-conquer](#divide-&-conquer) · [#math](#math) · [#ad-hoc](#ad-hoc) · [#greedy](#greedy) · [#dynamic-programming](#dynamic-programming) · [#computational-geometry](#computational-geometry) · [#searching](#searching) ·
...
- **number theory**
	- 🟡 [uva/547](https://github.com/brnpapa/competitive-programming/blob/master/uva/547.cpp): `find the longest DDF sequence`  → pre-process a array f, where f[i] is the sum of digits of all positive factors of i; think like sieve
	- 🟡 [uri/2291](https://github.com/brnpapa/competitive-programming/blob/master/uri/2291.cpp): `print n-th divine number, the one that is equal to the sum of the sum of each divisor from 1 to n`  → think like sieve
	- **module arithmetic**
		- 🟢 [uva/374](https://github.com/brnpapa/competitive-programming/blob/master/uva/374.cpp): `compute (a^n) % m, where a <= 2^31 and n <= 2^31`  → use fast power with mod
...
- **combinatorics**
	- 🟢 [codeforces/131-B](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/131-B.cpp) 
	- 🟢 [codeforces/459-B](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/459-B.cpp): `find the max difference between numbers of a given array and the number of ways to get it` 
	- **fibonacci numbers**
	...
	- **combinations**
		...
		- **multi-combinations**
			- 🟡 [codeforces/630-G](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/630-G.cpp)  → C(n+5-1,5) * C(n+3-1,3)
- **game theory**
	- **minimax**
...
- **iterative**
	...
	- 🟢 [codeforces/633-A](https://github.com/brnpapa/competitive-programming/blob/master/codeforces/633-A.cpp): `check if a diophantine equation has positive solution` 
