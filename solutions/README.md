...
<a href="https: //www.spoj.com/users/brnpapa"><img src="https://img.shields.io/static/v1?label=spoj&message=41&color=green&style=flat-square"></a>
</p>
<br/>

<h1 align="center">Solutions index</h1>

· [#geometry](#geometry) · [#strings](#strings) · [#brute-force](#brute-force) · [#dynamic-programming](#dynamic-programming) · [#data-structures](#data-structures) · [#greedy](#greedy) · [#math](#math) · [#ad-hoc](#ad-hoc) · [#divide-&-conquer](#divide-&-conquer) · [#miscellaneous](#miscellaneous) · [#graphs](#graphs) ·
...
- 😳 [uva/11240](https://github.com/brpapa/competitive-programming/blob/master/solutions/uva/11240.cpp): `length of the longest inc/dec (alternating) subsequence` 
...
- 🙂 [uva/11491](https://github.com/brpapa/competitive-programming/blob/master/solutions/uva/11491.cpp): `remove D digits from the given number, in a such way that the remain number is maximum` 
...
- **sparse table**
	- 🙂 [spoj/THRBL](https://github.com/brpapa/competitive-programming/blob/master/solutions/spoj/THRBL.cpp): `range max query` 
- **binary search**
...
- 🙂 [uva/11000](https://github.com/brpapa/competitive-programming/blob/master/solutions/uva/11000.cpp) 
...
- 🙂 [spoj/GOALFR](https://github.com/brpapa/competitive-programming/blob/master/solutions/spoj/GOALFR.cpp) 
