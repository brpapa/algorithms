...
<a href="https: //www.spoj.com/users/brnpapa"><img src="https://img.shields.io/static/v1?label=spoj&message=40&color=green&style=flat-square"></a>
</p>
<br/>

<h1 align="center">Solutions index</h1>

· [#graphs](#graphs) · [#miscellaneous](#miscellaneous) · [#geometry](#geometry) · [#ad-hoc](#ad-hoc) · [#dynamic-programming](#dynamic-programming) · [#greedy](#greedy) · [#data-structures](#data-structures) · [#strings](#strings) · [#brute-force](#brute-force) · [#divide-&-conquer](#divide-&-conquer) · [#math](#math) ·
...
- **iterative**
	...
	- **all subsets**
		- 🙂 [uva/12455](./uva/12455.cpp)  → use bitmasks
	- **all permutations**
		- 🙂 [uva/750](./uva/750.cpp) 
- **recursive backtracking**
	...
	- **sudoku**
		- 🙂 [uva/989](./uva/989.cpp) 
	- **n-queens**
		- 😳 [uva/11195](./uva/11195.cpp)  → use bitmasks
	- **pruned permutations**
...
- 😳 [uva/10651](./uva/10651.cpp)  → use bitmasks
